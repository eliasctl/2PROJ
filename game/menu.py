...
# Translate the menu text based on the selected language
translated_start_button_text = translator.translate(start_button.text, dest=selected_language).text
translated_settings_button_text = translator.translate(settings_button.text, dest=selected_language).text
translated_instruction_button_text = translator.translate(instruction_button.text, dest=selected_language).text
translated_back_button_text = translator.translate(back_button.text, dest=selected_language).text
translated_singleplayer_button_text = translator.translate(singleplayer_button.text, dest=selected_language).text
translated_multiplayer_button_text = translator.translate(multiplayer_button.text, dest=selected_language).text
translated_easy_button_text = translator.translate(easy_button.text, dest=selected_language).text
translated_hard_button_text = translator.translate(hard_button.text, dest=selected_language).text
translated_impossible_button_text = translator.translate(impossible_button.text, dest=selected_language).text
translated_instructions_text = translator.translate(instructions_text_box.text, dest=selected_language).text
translated_low_text = translator.translate(low_text_box.text, dest=selected_language).text
translated_high_text = translator.translate(high_text_box.text, dest=selected_language).text
translated_video_text = translator.translate(video_text_box.text, dest=selected_language).text
translated_sfx_text = translator.translate(sfx_text_box.text, dest=selected_language).text
translated_music_text = translator.translate(music_text_box.text, dest=selected_language).text
translated_help_text = translator.translate(help_text_box.text, dest=selected_language).text
translated_language_text = translator.translate(language_text_box.text, dest=selected_language).text

# Update the button texts with the translated texts
start_button.text = translated_start_button_text
settings_button.text = translated_settings_button_text
instruction_button.text = translated_instruction_button_text
back_button.text = translated_back_button_text
singleplayer_button.text = translated_singleplayer_button_text
multiplayer_button.text = translated_multiplayer_button_text
easy_button.text = translated_easy_button_text
hard_button.text = translated_hard_button_text
impossible_button.text = translated_impossible_button_text

# Update the text boxes with the translated texts
instructions_text_box.update_text(translated_instructions_text)
low_text_box.update_text(translated_low_text)
high_text_box.update_text(translated_high_text)
video_text_box.update_text(translated_video_text)
sfx_text_box.update_text(translated_sfx_text)
music_text_box.update_text(translated_music_text)
help_text_box.update_text(translated_help_text)
language_text_box.update_text(translated_language_text)